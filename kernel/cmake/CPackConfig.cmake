...
if(APPLE)
  set(CPACK_PACKAGE_VENDOR "Examour team") # PackageMaker doesn't like http://
else()
  set(CPACK_PACKAGE_VENDOR "https://github.com/remysaissy/examour-exokernel") # deb lintian insists on URL
endif()
