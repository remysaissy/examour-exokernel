...
#ifndef __LIBSLDS_NARY_TREE_COMMON_H__
#define __LIBSLDS_NARY_TREE_COMMON_H__

/*
 * This header provides code common to all nary trees.
 */
...
#endif /* __LIBSLDS_NARY_TREE_COMMON_H__ */
