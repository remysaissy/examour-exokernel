...
inline int __ctype_isalnum(int __c)
{
	return __ctypes[__c + 1] &
	    (__ctype_upper | __ctype_lower | __ctype_digit);
}

inline int __ctype_isalpha(int __c)
{
	return __ctypes[__c + 1] & (__ctype_upper | __ctype_lower);
}

inline int __ctype_isascii(int __c)
{
	return !(__c & ~0x7f);
}

inline int __ctype_isblank(int __c)
{
	return (__c == '\t') || (__c == ' ');
}

inline int __ctype_iscntrl(int __c)
{
	return __ctypes[__c + 1] & __ctype_cntrl;
}

inline int __ctype_isdigit(int __c)
{
	return ((unsigned)__c - '0') <= 9;
}

inline int __ctype_isgraph(int __c)
{
	return __ctypes[__c + 1] &
	    (__ctype_upper | __ctype_lower | __ctype_digit | __ctype_punct);
}

inline int __ctype_islower(int __c)
{
	return __ctypes[__c + 1] & __ctype_lower;
}

inline int __ctype_isprint(int __c)
{
	return __ctypes[__c + 1] & __ctype_print;
}

inline int __ctype_ispunct(int __c)
{
	return __ctypes[__c + 1] & __ctype_punct;
}

inline int __ctype_isspace(int __c)
{
	return __ctypes[__c + 1] & __ctype_space;
}

inline int __ctype_isupper(int __c)
{
	return __ctypes[__c + 1] & __ctype_upper;
}

inline int __ctype_isxdigit(int __c)
{
...
inline int __ctype_toupper(int __c)
{
	return __ctype_islower(__c) ? _toupper(__c) : __c;
}

inline int __ctype_tolower(int __c)
{
